...
export const dict = {
  ...
  "voice.listeningFor": "Lytter etter {{label}}",
  "voice.editLangInSettings": "Endre språk i innstillinger",
  ...
  "settings.anemos.mobile.unavailable": "Denne fanen er tilgjengelig på Anemos mobile bygg.",
