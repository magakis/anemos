...
export const dict = {
  ...
  "voice.listeningFor": "正在聆聽 {{label}}",
  "voice.editLangInSettings": "可在設定中修改語言",
  "voice.processingShort": "處理中",
  "voice.stop": "停止",
  ...
  "settings.general.notifications.push.permission.unsupported": "此裝置不支援通知",
  "settings.general.notifications.push.generic.title": "隱私",
  "settings.general.notifications.push.generic.description":
    "預設情況下提醒內容保持通用。提示文字、回覆文字、檔案路徑和工作階段標題保留在裝置上。",
  ...
  "settings.general.notifications.push.relay.description.empty":
    "請先連線到伺服器，或輸入自訂中繼 URL 進行配對和背景推播投遞。",
  ...
  "settings.general.notifications.push.pairing.step.claim": "正在將此 iPhone 連線到 OpenCode 主機。",
  "settings.general.notifications.push.pairing.step.finish": "正在完成此 iPhone 的配對。",
  "settings.general.notifications.push.pairing.action.setup": "設定",
  "settings.general.notifications.push.pairing.action.finish": "完成設定",
  "settings.general.notifications.push.pairing.action.repair": "修復",
  "settings.general.notifications.push.pairing.action.pairing": "配對中...",
  "settings.general.notifications.push.pairing.action.clear": "移除配對",
  "settings.general.notifications.push.pairing.action.clearing": "正在移除...",
  "settings.general.notifications.push.pairing.toast.cleared.title": "配對已移除",
  ...
  "settings.general.notifications.push.action.unavailable": "無法使用",
  "settings.general.notifications.push.action.checking": "檢查中...",
  "settings.general.notifications.push.action.test": "傳送測試",
  "settings.general.notifications.push.action.sending": "傳送中...",
  "settings.general.notifications.push.host.title": "主機整合",
  "settings.general.notifications.push.host.description.missing":
    "請在已連線的 OpenCode 主機上安裝社群外掛程式，以便轉發通用的推播事件。",
  "settings.general.notifications.push.host.description.installed": "社群外掛程式已列在此主機的 OpenCode 全域設定中。",
  "settings.general.notifications.push.host.description.updating": "正在更新主機外掛程式的 OpenCode 全域設定。",
  "settings.general.notifications.push.host.action.install": "新增到設定",
  "settings.general.notifications.push.host.action.installing": "安裝中...",
  "settings.general.notifications.push.host.action.copy": "複製命令",
  "settings.general.notifications.push.host.action.copying": "複製中...",
